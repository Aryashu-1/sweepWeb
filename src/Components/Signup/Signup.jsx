  ...
  return (
    <div className='m-6'>
        <div className='text-center '>
          <img className='m-auto w-40' alt="" src='https://static.vecteezy.com/system/resources/thumbnails/006/720/912/small/green-leaf-natural-leaf-icon-logo-design-template-vector.jpg'></img>
        <h1 className='font-semibold text-2xl'> SWEEP</h1>        
        </div>

        <div className=' border-green-400 rounded-md my-4 border-2 w-96 m-auto '>
            ...
            <input   placeholder='First and last name' className='w-full  shadow-green-500 shadow-md border-gray-500 border-2  text-black p-1 rounded-sm' type='' {...register('Name', {required:true})}></input>
            ...
            <input   placeholder='Mobile Number' className='border-gray-500 border-2  shadow-green-500 shadow-md text-black p-1 rounded-sm' type='' {...register('Number', {required:true, maxLength:10,minLength:10})}></input>
            ...
            <input   placeholder='Pincode' className='w-full  shadow-green-500 shadow-md border-gray-500 border-2  text-black p-1 rounded-sm' type='' {...register('Number', {required:true, maxLength:6,minLength:6})}></input>
            ...
            <input   className='w-full border-gray-500 border-2 shadow-green-500 shadow-md text-black p-1 rounded-sm' type='email' {...register('Email', {required:true, minLength:8})}></input>
            ...
            <input  id='Pass' className='w-full border-gray-500 border-2 s shadow-green-500 shadow-md text-black p-1 rounded-sm' type='password' {...register('Pass', {required:true, minLength:8})}></input>
            ...
            <div className='text-center'>
            <button type='submit' className=' bg-green-500 text-lg rounded-xl p-3 text-white hover:bg-sky-600     '>Sign Up</button>
            </div>
            
            </form>
            <p className='text-center text-lg py-3'>Already Registered !
              <NavLink to='/login' className='underline px-3 text-green-500 font-semibold text-lg'>Login</NavLink>
            </p>
                    </div>
    </div>
  )
